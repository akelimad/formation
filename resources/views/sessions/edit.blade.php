...
<div class="container-fluid">
    <div class="row">
        <div class="col-md-10 col-md-offset-1">
            <div class="card">
                <form id="allInputsFormValidation" action="{{ url('sessions/'.$s->id) }}" method="post">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="start" data-date-format="DD/MM/YYYY HH:mm" class="form-control datepicker" required="" value="{{ Carbon\Carbon::parse($s->start)->format('d/m/Y H:i') }}" />
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="label-control">Date de fin <star>*</star> </label>
                                    <input type="text" name="end" data-date-format="DD/MM/YYYY HH:mm" class="form-control datepicker" required="" value="{{ Carbon\Carbon::parse($s->end)->format('d/m/Y H:i') }}" />
                                </div>
                            </div>
                        </div>
                        <div class="row">
