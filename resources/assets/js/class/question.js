...
export default class chmQuestion {
  ...
  static create (params) {
    window.chmModal.show({type: 'GET', url: window.chmSite.url('questionnaires/' + params.eid + '/create'), data: {eid: params.eid}}, {
      form: {
  ...
  static edit (params) {
    window.chmModal.show({type: 'GET', url: window.chmSite.url('questionnaires/' + params.id + '/edit')}, {
      form: {
        class: 'allInputsFormValidation form-horizontal',
        callback: 'chmQuestion.store'
      },
  ...
  static show (params) {
    window.chmModal.show({type: 'GET', url: window.chmSite.url('questionnaires/' + params.id)}, {
      width: 850
    })
  }
  ...
  static store (event) {
    ...
    var ajaxParams = {
      id: id,
      type: 'POST',
      url: window.chmSite.url('questionnaires/store'),
      data: data,
      processData: false,
      contentType: false,
      cache: false,
  ...
  static delete (params) {
    ...
    var object = window.chmModal.show({type: 'DELETE', url: window.chmSite.url('questionnaires/' + params.id + '/delete'), data: {'_token': token}}, {
