...
export default class chmParticipant {

  static create () {
    window.chmModal.show({type: 'GET', url: window.chmSite.url('participants/create')}, {
      form: {
        class: 'allInputsFormValidation',
        callback: 'chmParticipant.store'
      },
      footer: {
        label: 'Sauvegarder'
      }
  ...
  static edit (params) {
    window.chmModal.show({type: 'GET', url: window.chmSite.url('participants/' + params.id + '/edit')}, {
      form: {
        class: 'allInputsFormValidation',
        callback: 'chmParticipant.store'
      },
  ...
  static show (params) {
    window.chmModal.show({type: 'GET', url: window.chmSite.url('participants/' + params.id)})
  }
  ...
  static store (event) {
    ...
    var ajaxParams = {
      id: id,
      type: 'POST',
      url: window.chmSite.url('participants/store'),
      data: data,
      processData: false,
      contentType: false,
      cache: false,
  ...
  static delete (params) {
    ...
    var object = window.chmModal.show({type: 'DELETE', url: window.chmSite.url('participants/' + params.id + '/delete'), data: {'_token': token}}, {
