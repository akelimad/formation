...
export default class chmFormateur {

  static create () {
    window.chmModal.show({type: 'GET', url: window.chmSite.url('formateurs/create')}, {
      form: {
        class: 'allInputsFormValidation',
        callback: 'chmFormateur.store'
      },
      footer: {
        label: 'Sauvegarder'
      }
  ...
  static edit (params) {
    window.chmModal.show({type: 'GET', url: window.chmSite.url('formateurs/' + params.id + '/edit')}, {
      form: {
        class: 'allInputsFormValidation',
        callback: 'chmFormateur.store'
      },
  ...
  static show (params) {
    window.chmModal.show({type: 'GET', url: window.chmSite.url('formateurs/' + params.id)})
  }
  ...
  static store (event) {
    ...
    var ajaxParams = {
      id: id,
      type: 'POST',
      url: window.chmSite.url('formateurs/store'),
      data: data,
      processData: false,
      contentType: false,
      cache: false,
  ...
  static delete (params) {
    ...
    var object = window.chmModal.show({type: 'DELETE', url: window.chmSite.url('formateurs/' + params.id + '/delete'), data: {'_token': token}}, {
