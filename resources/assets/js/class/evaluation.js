...
export default class chmEvaluation {

  static create () {
    window.chmModal.show({type: 'GET', url: window.chmSite.url('evaluations/create')}, {
      form: {
        class: 'allInputsFormValidation',
        callback: 'chmEvaluation.store'
      },
      footer: {
        label: 'Sauvegarder'
      }
  ...
  static edit (params) {
    window.chmModal.show({type: 'GET', url: window.chmSite.url('evaluations/' + params.id + '/edit')}, {
      form: {
        class: 'allInputsFormValidation',
        callback: 'chmEvaluation.store'
      },
  ...
  static show (params) {
    window.chmModal.show({type: 'GET', url: window.chmSite.url('evaluations/' + params.id)})
  }
  ...
  static store (event) {
    ...
    var ajaxParams = {
      id: id,
      type: 'POST',
      url: window.chmSite.url('evaluations/store'),
      data: data,
      processData: false,
      contentType: false,
      cache: false,
  ...
  static delete (params) {
    ...
    var object = window.chmModal.show({type: 'DELETE', url: window.chmSite.url('evaluations/' + params.id + '/delete'), data: {'_token': token}}, {
