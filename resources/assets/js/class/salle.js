...
export default class chmSalle {

  static create () {
    window.chmModal.show({type: 'GET', url: window.chmSite.url('salles/create')}, {
      form: {
        class: 'allInputsFormValidation',
        callback: 'chmSalle.store'
      },
      footer: {
        label: 'Sauvegarder'
      }
  ...
  static edit (params) {
    window.chmModal.show({type: 'GET', url: window.chmSite.url('salles/' + params.id + '/edit')}, {
      form: {
        class: 'allInputsFormValidation',
        callback: 'chmSalle.store'
      },
  ...
  static show (params) {
    window.chmModal.show({type: 'GET', url: window.chmSite.url('salles/' + params.id)})
  }
  ...
  static store (event) {
    ...
    var ajaxParams = {
      id: id,
      type: 'POST',
      url: window.chmSite.url('salles/store'),
      data: data,
      processData: false,
      contentType: false,
      cache: false,
  ...
  static delete (params) {
    ...
    var object = window.chmModal.show({type: 'DELETE', url: window.chmSite.url('salles/' + params.id + '/delete'), data: {'_token': token}}, {
